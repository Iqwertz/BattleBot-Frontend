...
import { SetPlacingBot, SetEditing } from '../../store/app.action';
...
export class PlayComponent implements OnInit {
  ...
  constructor(
    ...
    simulationService.generateNewSimulation([50, 50], false, true);
  ...
  checkAllBotsPlaced() {
    console.log(this.simulationService.simulation.bots.size);
    if (
